...
function activate_for_current_blog() {
	...
	if ( ! Model\FileType::has_entries() ) {
		$default_types = array(
			...
			array( 'name' => 'OSF Shownotes',          'type' => 'shownotes','mime_type' => 'text/plain',           'extension' => 'osf.txt' ),
			array( 'name' => 'MD Shownotes',           'type' => 'shownotes','mime_type' => 'text/plain',           'extension' => 'md' )
		);
